...
# 4.Set WEBHOOK_URL to your public domain, then:
bun run start
```
...
# Start the bot (auto-starts ngrok + registers webhook url and secret + creates DB)
bun run dev
```
...
> [!WARNING]
> Unless you're trying to deploy this for prod, don't worry about these. 
> For local dev, bun run dev generates WEBHOOK_URL and WEBHOOK_SECRET.
...
| `WEBHOOK_URL` | Yes | — | Public HTTPS URL for Telegram webhook |
