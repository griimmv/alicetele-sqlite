...
# Fill in BOT_TOKEN, WEBHOOK_URL (your public url that telegram can webhook to), and OPENAI_API_KEY(optional) on .env.local
...
| `OPENAI_MODEL` | Optional | `gpt-5.4-mini` | OpenAI model name |
